...
1. **GitHub Pages source**, Settings → Pages → **GitHub Actions** (not “Deploy from a branch → main”). If the site shows a blank page, open View Source: a broken deploy still has `<script src="/src/main.tsx">` instead of `/assets/index-*.js`.
